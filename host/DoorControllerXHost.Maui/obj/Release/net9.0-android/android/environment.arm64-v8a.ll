...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [41 x i8] c"com.companyname.doorcontrollerxhost.maui\00", align 1
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [39 x i8] c"libaot-DoorControllerXHost.Core.dll.so\00", align 1
@.DSOCacheEntry.9_name = private unnamed_addr constant [39 x i8] c"libaot-DoorControllerXHost.Maui.dll.so\00", align 1
