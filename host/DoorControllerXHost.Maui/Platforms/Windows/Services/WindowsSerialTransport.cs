...
namespace DoorControllerXHost.Maui.Platforms.Windows.Services;

internal sealed class WindowsSerialTransport : ITransportClient
{
    ...
    {
        DisconnectAsync(cancellationToken).GetAwaiter().GetResult();
